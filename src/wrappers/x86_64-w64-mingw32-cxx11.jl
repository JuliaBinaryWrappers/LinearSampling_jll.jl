# Autogenerated wrapper script for LinearSampling_jll for x86_64-w64-mingw32-cxx11
...
function __init__()
    ...
    JLLWrappers.@init_executable_product(
        ...
        "bin\\exact_linearsampling_lazysaving.exe",
    )

    JLLWrappers.@init_executable_product(
        exact_linearsampling_nonsaving,
        "bin\\exact_linearsampling_nonsaving.exe",
    )

    JLLWrappers.@init_executable_product(
        linearsampling_lazysaving,
        "bin\\linearsampling_lazysaving.exe",
    )

    JLLWrappers.@init_executable_product(
        linearsampling_nonsaving,
        "bin\\linearsampling_nonsaving.exe",
    )
